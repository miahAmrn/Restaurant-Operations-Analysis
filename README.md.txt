...
This project analyzes customer behavior and menu performance for "The Taste of the World" restaurant, which recently debuted a new menu. The analysis focuses on exploring menu items, order details, and customer preferences to understand how customers are reacting to the new offerings.
